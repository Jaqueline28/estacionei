...
--
-- Host: 127.0.0.1
-- Tempo de geração: 18-Abr-2023 às 02:16
...
INSERT INTO `carros` (`pk_carros`, `placa`, `entrada`, `saida`, `fk_vagas`, `fk_preco`) VALUES
(78, 'LWX2590', '2023-04-17 21:15:00', NULL, 1, 80),
(79, 'LWX2585', '2023-04-17 21:15:00', NULL, 2, 81);
...
INSERT INTO `precos` (`pk_preco`, `preco`) VALUES
(80, NULL),
(81, NULL);
...
--
ALTER TABLE `carros`
  MODIFY `pk_carros` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;

--
-- AUTO_INCREMENT de tabela `precos`
--
ALTER TABLE `precos`
  MODIFY `pk_preco` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
